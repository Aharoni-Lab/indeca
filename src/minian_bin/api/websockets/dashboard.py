...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, client_id: str = None, session_id: str = None) -> str:
    ...
    async def send_personal_message(self, message: dict, client_id: str):
        ...
        if client_id in self.active_connections:
            try:
                ...
                await self.active_connections[client_id].send_json(json_compatible_message)
